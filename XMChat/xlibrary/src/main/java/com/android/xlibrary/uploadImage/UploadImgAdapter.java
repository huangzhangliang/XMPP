package com.android.xlibrary.uploadImage;
...
import com.android.xlibrary.uploadImage.utils.BitmapHelper;
...
public class UploadImgAdapter {
    ...
    private void clickQuickOption(View v) {
        ...
        } else if (i == R.id.tv_select) {//                Intent albumIntent = new Intent(Intent.ACTION_PICK); // 老版本的相册
