...
public class ContactAdapter extends RecyclerAdapter<ContactBean> {

    public ContactAdapter(Context context, RecyclerView recyclerView) {
    ...
    @Override
    protected void convert(BaseViewHolder holder, ContactBean item) {
    ...
    private class VideoHolder extends BaseViewHolder {
        ...
        public void bind(final ContactBean item) {
            mItemBinding.tvUserName.setText(item.nickname);
            mItemBinding.tvUserAccount.setText(item.account);
        }
    }
